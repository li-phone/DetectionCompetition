...
model = dict(
    type='CascadeRCNN',
    num_stages=3,
    pretrained='../work_dirs/pretrained/resnet50-19c8e357.pth',
    backbone=dict(
        type='DB_ResNet',
        depth=50,
        num_stages=4,
...
data_root = r'E:\liphone\data\images\detections\cartoon_face'
img_norm_cfg = dict(
...
# yapf:enable
# runtime settings
dataset_name = 'garbage_huawei'
first_model_cfg = None
total_epochs = 12
dist_params = dict(backend='nccl')
log_level = 'INFO'
work_dir = '../work_dirs/' + dataset_name + '/cascade_rcnn_cbnet_db_r50_fpn_1x'
resume_from = None
