...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=(2221, 1333), ratio_range=(0.8, 1.2), keep_ratio=True),
...
test_pipeline = [
    ...
    dict(
        ...
        img_scale=[(1777, 1066), (2221, 1333), (2665, 1600)],
        # img_scale=(1333, 800),
        flip=True,
        transforms=[
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/slice_1333x1333_train.json',
        img_prefix=data_root + 'slice_1333x1333',
        classes=CLASSES,
...
log_level = 'INFO'
load_from = 'work_dirs/cas_r50-best-slice_1333x1333/latest.pth'
