...
test_pipeline = [
    ...
    dict(
        ...
        # img_scale=[
        #     (682, 410), (853, 512), (1024, 614),
        #     (853, 512), (1066, 640), (1280, 768),
        #     (1024, 614), (1280, 768), (1536, 922),
        #
        #     (1066, 640), (1333, 800), (1600, 960),
        #
        #     (1024, 614), (1280, 768), (1536, 922),
        #     (1280, 768), (1600, 960), (1920, 1152),
        #     (1536, 922), (1920, 1152), (2304, 1382),
        # ],
        img_scale=[
            (682, 410),
            (853, 512),
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/slice_resize_0.5_1.0-train.json',
        img_prefix=data_root + 'slice_resize_0.5_1.0',
        classes=CLASSES,
...
log_level = 'INFO'
load_from = 'work_dirs/cas_r101-best-slice_1000x1000-softnms-aug-800x800/latest.pth'
