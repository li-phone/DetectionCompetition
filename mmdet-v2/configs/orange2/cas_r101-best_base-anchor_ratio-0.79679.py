...
model = dict(
    ...
    rpn_head=dict(
        ...
        anchor_generator=dict(
            ...
            scales=[8],
            ratios=[1.39408633, 0.7207879, 1.5078614, 0.83100173, 1.02412223, 0.84519076, 0.81275371],
            # ratios=[0.5, 1.0, 2.0],
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/slice_800x800_1000x1000_train.json',
        img_prefix=data_root + 'slice_800x800_1000x1000',
        classes=CLASSES,
