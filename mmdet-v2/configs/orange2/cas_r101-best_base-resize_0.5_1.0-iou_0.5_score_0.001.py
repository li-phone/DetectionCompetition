...
test_pipeline = [
    ...
    dict(
        ...
        img_scale=[
            (1600, 960), (2000, 1200), (2400, 1440),
            (1066, 640), (1333, 800),
            (533, 320), (667, 400), (800, 480),
        ],
        # img_scale=(1333, 800),
        flip=True,
        transforms=[
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/finetune-slice_resize_0.5_1.0-iou_0.5_score_0.001.json',
...
log_level = 'INFO'
load_from = 'work_dirs/cas_r101-best_base-800x800_1000x1000_ovlap_0.5-resize_0.5_1.0/latest.pth'
