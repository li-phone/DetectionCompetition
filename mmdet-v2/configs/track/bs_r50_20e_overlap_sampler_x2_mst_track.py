...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/cut_4000x4000_overlap_70/instance_train.json',
        img_prefix=data_root + 'trainval/cut_4000x4000_overlap_70',
        classes=('car', 'full body', 'head', 'visible body'),
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/cut_4000x4000_overlap_70/instance_val.json',
        img_prefix=data_root + 'trainval/cut_4000x4000_overlap_70',
        classes=('car', 'full body', 'head', 'visible body'),
