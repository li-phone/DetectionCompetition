...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/instance-train-best-iou_0.8_score_0.8_iter_1.json',
...
log_level = 'INFO'
load_from = 'work_dirs/cas_r50-best-finetune_data_iou_0.8_score_0.8_iter_1/latest.pth'
resume_from = None
