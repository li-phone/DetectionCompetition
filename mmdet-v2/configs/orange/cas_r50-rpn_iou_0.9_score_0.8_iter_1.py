...
test_pipeline = [
    ...
    dict(
        ...
        # img_scale=[(1066, 640), (1200, 720), (1333, 800), (1466, 880), (1600, 960)],
        # img_scale=(1333, 800),
        flip=True,
        transforms=[
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/doublehead-rpn-3-DIouLoss-predict-iou_0.9_score_0.8_iter_1.json',
...
log_level = 'INFO'
# load_from = 'work_dirs/cas_r50-best/latest.pth'
