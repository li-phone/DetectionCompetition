...
def main():
    ...
    parser.add_argument(
        '--result',
        default='/home/liphone/undone-work/uselessNet/code/mmdetection/work_dirs/alcohol/cascade_rcnn_r50_fpn_1x/4_stage/latest_epoch_12_out.pkl.bbox.json',
        help='result file path')
    parser.add_argument(
        '--ann',
        default='/home/liphone/undone-work/data/detection/alcohol/annotations/instances_train_20191223_annotations.json',
