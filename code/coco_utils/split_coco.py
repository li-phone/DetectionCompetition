...
def main():
    ann_path = r'E:\data\images\detections\fabric_defects\coco_fabric\plain_fabric\annotations\instance_all.json'
    save_dir = r'E:\data\images\detections\fabric_defects\coco_fabric\plain_fabric\annotations'
    split_coco(ann_path, save_dir)
