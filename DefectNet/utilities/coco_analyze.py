...
def main():
    ...
    # defect network
    count_data(data_root + '/annotations/instance_train,type=34,.json', 'all')
    count_data(data_root + '/annotations/instance_train_rate=0.80.json', 'train')
    count_data(data_root + '/annotations/instance_test_rate=0.80.json', 'test')
